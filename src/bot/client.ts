...
import * as mentionCmd from "./commands/mention.js";
import * as usageCmd from "./commands/usage.js";

const commands = [registerCmd, unregisterCmd, statusCmd, stopCmd, autoApproveCmd, sessionsCmd, clearSessionsCmd, lastCmd, queueCmd, modelCmd, mentionCmd, usageCmd];
